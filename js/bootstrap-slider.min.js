      ...
      function i(t) {
        ...
        function n(e, i) {
          t.fn[e] = function (n) {
            if ("string" == typeof n) {
              for (
                var a = s.call(arguments, 1), r = 0, l = this.length;
                l > r;
                r++
              ) {
                var h = this[r],
            ...
            var d = this.map(function () {
              ...
              return (
                s
                  ? (s.option(n), s._init())
                  : ((s = new i(this, n)), t.data(this, e, s)),
                t(this)
              );
            });
      ...
      function n(e, i) {
        ...
        (this._state = {
          ...
          "string" == typeof e
            ...
            : e instanceof HTMLElement && (this.element = e),
          (i = i ? i : {});
        for (
          var n = Object.keys(this.defaultOptions), o = 0;
          o < n.length;
          o++
        ) {
          var r = n[o],
            l = i[r];
          (l = "undefined" != typeof l ? l : s(this.element, r)),
            (l = null !== l ? l : this.defaultOptions[r]),
        ...
        if (this.sliderElem) m = !0;
          ...
          if (
            ...
            for (var v = 0; v < this.options.rangeHighlights.length; v++) {
              ...
              (y.className = "slider-rangeHighlight slider-selection"),
          ...
          if (
            (b &&
              ...
              d.setAttribute("aria-labelledby", this.options.labelledby[0]),
            b &&
              this.options.labelledby[1] &&
              p.setAttribute("aria-labelledby", this.options.labelledby[1]),
            !b &&
            ...
            for (
              this.ticksContainer = document.createElement("div"),
                ...
                o = 0;
              o < this.options.ticks.length;
              o++
            ) {
              var w = document.createElement("div");
              if (((w.className = "slider-tick"), this.options.ticks_tooltip)) {
                var C = this._addTickListener(),
                  x = C.addMouseEnter(this, w, o),
                  k = C.addMouseLeave(this, w);
                this.ticksCallbackMap[o] = { mouseEnter: x, mouseLeave: k };
              }
          ...
          if (
            ...
            for (
              ...
              var L = document.createElement("div"),
                ...
                D =
                  this.options.reversed && P
                    ? this.options.ticks_labels.length - (o + 1)
                    : o;
              (L.className = "slider-tick-label"),
                (L.innerHTML = this.options.ticks_labels[D]),
          ...
          (M.className = "tooltip tooltip-main"),
            M.setAttribute("role", "presentation"),
            T(M);
          var S = document.createElement("div");
          (S.className = "tooltip tooltip-min"),
            S.setAttribute("role", "presentation"),
            T(S);
          var E = document.createElement("div");
          (E.className = "tooltip tooltip-max"),
        ...
        if (
          ...
          a[this.options.scale] && (this.options.scale = a[this.options.scale]),
          m === !0 &&
          ...
          Array.isArray(this.options.value)
            ...
            : (this._state.value = this.options.value),
          (this.trackLow = u || this.trackLow),
          (this.trackSelection = h || this.trackSelection),
          (this.trackHigh = c || this.trackHigh),
        ...
        var I = ["round", "triangle", "custom"],
          z = -1 !== I.indexOf(this.options.handle);
        if (z)
          for (
        ...
        if (
          ...
          if (
            ...
            var O = this._addTickListener(),
              A = O.addMouseEnter(this, this.handle1),
              N = O.addMouseLeave(this, this.handle1);
            (this.handleCallbackMap.handle1 = { mouseEnter: A, mouseLeave: N }),
              (A = O.addMouseEnter(this, this.handle2)),
              (N = O.addMouseLeave(this, this.handle2)),
          ...
          linear: {
            toValue: function (t) {
              ...
              if (this.options.ticks_positions.length > 0) {
                for (
                  var s, n, o, a = 0, r = 1;
                  r < this.options.ticks_positions.length;
                  r++
                )
                  if (t <= this.options.ticks_positions[r]) {
                    (s = this.options.ticks[r - 1]),
                      (o = this.options.ticks_positions[r - 1]),
                      (n = this.options.ticks[r]),
                      (a = this.options.ticks_positions[r]);
                    break;
                  }
                var l = (t - o) / (a - o);
                (e = s + l * (n - s)), (i = !1);
              ...
              if (this.options.ticks_positions.length > 0) {
                for (
                  ...
                  if (t <= this.options.ticks[o]) {
                    (e = o > 0 ? this.options.ticks[o - 1] : 0),
                      (s = o > 0 ? this.options.ticks_positions[o - 1] : 0),
                      (i = this.options.ticks[o]),
                      (n = this.options.ticks_positions[o]);
                    break;
                  }
                if (o > 0) {
                  var a = (t - e) / (i - e);
      ...
      (s = function (t, e) {
        ...
        (s.prototype = {
          ...
          setValue: function (t, e, i) {
            ...
            return (
              this._setDataVal(o),
              e === !0 && this._trigger("slide", o),
              s !== o &&
                i === !0 &&
                this._trigger("change", { oldValue: s, newValue: o }),
              this
            );
          },
          destroy: function () {
          ...
          off: function (e, i) {
            t
              ? (this.$element.off(e, i), this.$sliderElem.off(e, i))
              : this._unbindNonQueryEventHandler(e, i);
          },
          ...
          _setToolTipOnMouseOver: function (t) {
            ...
            var i = this.options.formatter(
                t ? t.value[0] : this._state.value[0]
              ),
              s = t
                ? e(t, this.options.reversed)
                : e(this._state, this.options.reversed);
              ...
              addMouseEnter: function (t, e, i) {
                var s = function () {
                  var e = t._state,
                    ...
                    n = parseInt(s, 10);
                  (e.value[0] = n),
                    (e.percentage[0] = t.options.ticks_positions[n]),
                    t._setToolTipOnMouseOver(e),
                    t._showTooltip();
                };
          ...
          _layout: function () {
            ...
            if (
              ...
              for (var e = 0; e < this.options.rangeHighlights.length; e++) {
                var i = this._toPercentage(
                    this.options.rangeHighlights[e].start
                  ),
                ...
                o
                  ? "vertical" === this.options.orientation
                    ? ((this.rangeHighlightElements[e].style.top =
                        o.start + "%"),
                      (this.rangeHighlightElements[e].style.height =
                        o.size + "%"))
                    : ((this.rangeHighlightElements[e].style.left =
                        o.start + "%"),
                      (this.rangeHighlightElements[e].style.width =
                        o.size + "%"))
                  : (this.rangeHighlightElements[e].style.display = "none");
              }
            if (
              Array.isArray(this.options.ticks) &&
              this.options.ticks.length > 0
              ...
              var a =
                ...
                r =
                  "vertical" === this.options.orientation
                    ? "marginTop"
                    : "marginLeft",
                l = this._state.size / (this.options.ticks.length - 1);
              if (this.tickLabelContainer) {
                var h = 0;
                if (0 === this.options.ticks_positions.length)
                  "vertical" !== this.options.orientation &&
                    (this.tickLabelContainer.style[r] = -l / 2 + "px"),
                    (h = this.tickLabelContainer.offsetHeight);
                else
                  for (
                    u = 0;
                    u < this.tickLabelContainer.childNodes.length;
                    u++
                  )
                    this.tickLabelContainer.childNodes[u].offsetHeight > h &&
                      (h = this.tickLabelContainer.childNodes[u].offsetHeight);
                "horizontal" === this.options.orientation &&
                  (this.sliderElem.style.marginBottom = h + "px");
              }
              for (var u = 0; u < this.options.ticks.length; u++) {
                var c =
                  this.options.ticks_positions[u] ||
                  this._toPercentage(this.options.ticks[u]);
                this.options.reversed && (c = 100 - c),
                  (this.ticks[u].style[this.stylePos] = c + "%"),
                  this._removeClass(this.ticks[u], "in-selection"),
                  this.options.range
                    ? c >= t[0] &&
                      c <= t[1] &&
                      this._addClass(this.ticks[u], "in-selection")
                    ...
                    : "before" === this.options.selection &&
                      ...
                      this._addClass(this.ticks[u], "in-selection"),
                  this.tickLabels[u] &&
                    ((this.tickLabels[u].style[a] = l + "px"),
                    "vertical" !== this.options.orientation &&
                    void 0 !== this.options.ticks_positions[u]
                      ? ((this.tickLabels[u].style.position = "absolute"),
                        (this.tickLabels[u].style[this.stylePos] = c + "%"),
                        (this.tickLabels[u].style[r] = -l / 2 + "px"))
                      : "vertical" === this.options.orientation &&
                        ((this.tickLabels[u].style.marginLeft =
            ...
            if (this.options.range) {
              (d = this.options.formatter(this._state.value)),
              ...
              (d = this.options.formatter(this._state.value[0])),
                this._setText(this.tooltipInner, d),
          ...
          _isHighlightRange: function (t, e) {
            return t >= 0 && 100 >= t && e >= 0 && 100 >= e ? !0 : !1;
          },
          _resize: function (t) {
            (this._state.offset = this._offset(this.sliderElem)),
              (this._state.size = this.sliderElem[this.sizePos]),
          ...
          _keydown: function (t, e) {
            ...
            if (i) {
              ...
              var o = this._state.value[t] + i * this.options.step;
              return (
                this.options.range &&
                  (o = [
                    t ? this._state.value[0] : o,
                    t ? o : this._state.value[1],
                  ]),
          ...
          _adjustPercentageForRangeSliders: function (t) {
            if (this.options.range) {
              ...
              this._applyToFixedAndParseFloat(this._state.percentage[1], e) < i
                ? ((this._state.percentage[0] = this._state.percentage[1]),
          ...
          _validateArray: function (t) {
            for (var e = 0; e < t.length; e++) {
              var i = t[e];
              if ("number" != typeof i)
                throw new Error(o.formatInvalidInputErrorMsg(i));
            }
          },
          ...
          _removeClass: function (t, e) {
            for (
              var i = e.split(" "), s = t.className, n = 0;
              n < i.length;
              n++
            ) {
              var o = i[n],
