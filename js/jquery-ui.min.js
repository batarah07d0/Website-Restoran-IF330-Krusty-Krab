          ...
          return (
            ...
            this.each(function () {
              var s,
                ...
                D = t.extend({}, m),
                I = e(x.my, l.outerWidth(), l.outerHeight());
              "right" === n.my[0]
                ? (D.left -= h)
  ...
  t.extend(s.prototype, {
    ...
    parseDate: function (e, i, s) {
      ...
      if (
        ...
        for (m = 1, _ = v; (o = this._getDaysInMonth(g, m - 1)), !(o >= _); )
          m++, (_ -= o);
      if (
      ...
      for (
        t.drawMonth = J,
          ...
          i = K
            ? this.formatDate(
                i,
                this._daylightSavingAdjust(new Date(tt, J - $, 1)),
        ...
        for (k = "", this.maxRows = 4, C = 0; U[1] > C; C++) {
          if (
            ((D = this._daylightSavingAdjust(new Date(tt, J, t.selectedDay))),
            (I = " ui-corner-all"),
            (T = ""),
            X)
          ) {
          ...
          for (
            T += P + "</tr></thead><tbody>",
              ...
              H = (this._getFirstDayOfMonth(tt, J) - c + 7) % 7,
              z = Math.ceil((H + S) / 7),
              O = X && this.maxRows > z ? this.maxRows : z,
              this.maxRows = O,
              A = this._daylightSavingAdjust(new Date(tt, J, 1 - H)),
              E = 0;
            O > E;
            E++
          ) {
